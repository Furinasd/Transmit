...
def build():
    ...
    bridge=spawn(unreal.TransmitBridgeSlab,'Learn_BridgeSlab',(680,0,25))
    bridge.motion.set_editor_property('participant_id','Learn.Bridge');bridge.body.set_material(0,MATS['Cyan'])
    bridge.slab_collision.set_box_extent(V(500,220,15));bridge.body.set_relative_scale3d(V(10,4.4,.3))
    endpoint('Learn_Source',(180,-430,120))
    box('Learn_SourcePlinth',(180,-430,30),(180,180,60),'Chalk')
    for y in [-650,650]:
        box('Learn_ParapetNear_'+str(y),(400,y,250),(1600,80,500),'Chalk')
        box('Learn_ParapetFar_'+str(y),(2500,y,250),(800,80,500),'Chalk')
    ...
    text('Learn_Controls',(170,-605,230),'E  TAKE     Q  GIVE     R  RESTART',24,90)
    ...
    box('Route_CatchStop',(5480,-100,120),(80,500,240),'Chalk',-60)
    ...
    box('Route_EntryConnector',(7000,-400,-60),(1000,1000,120),'Slate')
    line('Route_InterceptGuide',(5100,-950,6),(5100,-120,6),20,8,'Cyan')
    line('Route_EntryGuideA',(5800,-650,6),(7000,-500,6),20,8,'Cyan')
    line('Route_EntryGuideB',(7000,-500,6),(7000,700,6),20,8,'Cyan')
    ...
    box('Weaponize_SouthWallWest',(6280,-150,350),(200,80,700),'Chalk')
    box('Weaponize_SouthWallEast',(7820,-150,350),(1200,80,700),'Chalk')
    ...
    box('Weaponize_EntryBaffle',(6700,1180,280),(1440,100,560),'Chalk')
    box('Weaponize_FarBaffle',(6700,2260,280),(1440,100,560),'Chalk')
