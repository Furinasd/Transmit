...
class TransmitRun:
 def __init__(self):
  ...
  self.wait('bridge spans gap',lambda:self.a['Learn_BridgeSlab'].is_blocked_by_collision(),12)
  ...
  for pos in [(2850,-920),(3750,-920),(4770,-920),(5150,-700)]:self.walk(pos)
  ...
  for pos in [(5200,-750),(5940,-650),(7000,-500),(7620,700),(7620,1420)]:self.walk(pos)
